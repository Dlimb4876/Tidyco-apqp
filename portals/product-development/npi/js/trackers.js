...
export function renderActions() {
  ...
  <div style="display:flex;gap:8px;flex-shrink:0"><button class="btn btn-ghost btn-sm" onclick="goHome()">← Dashboard</button><button class="btn btn-primary btn-sm" onclick="addAction()">＋ Add Action</button></div></div>
...
export function renderRisks() {
  ...
  <div style="display:flex;gap:8px;flex-shrink:0"><button class="btn btn-ghost btn-sm" onclick="goHome()">← Dashboard</button><button class="btn btn-primary btn-sm" onclick="addRisk()">＋ Add Risk</button></div></div>
  <div style="display:flex;gap:10px;margin-bottom:16px">
