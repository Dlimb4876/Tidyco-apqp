...
npi.ctq.render = function() {
  ...
  const rows = p.ctq.map((r, i) => `<tr>
    ...
    <td><div class="ctq-agreed">
      <input type="checkbox" ${r.customerAgreed ? 'checked' : ''} data-action="ctq-upd" data-idx="${i}" data-field="customerAgreed" title="Customer has agreed this CTQ method and out-of-spec plan">
