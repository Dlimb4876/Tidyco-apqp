...
- `hub.js` — js/features/hub.js (~4135 tok)
...
- `product-development.js` — Product Development Portal Hub (~9689 tok)
...
- `settings.css` — Styles: 72 rules, 6 vars, 3 media queries (~3199 tok)
