...
- [ ] **Delete** `portals/productmgmt/js/productmgmt.js`
- [ ] **Delete** `portals/productmgmt/css/productmgmt.css`
- [ ] **Delete** `portals/productmgmt/` folder (will be empty after above)
- [ ] **Remove** `productmgmt` from `BACK_BUTTON_LABELS` in `utils/js/navigation.js` (line 28)
- [ ] **Delete** `portals/product-development/npi/css/apqp.css`
- [ ] **Decide** on `portals/capacity/js/me-estimation-page.js` — add to `index.html` or delete it (and its CSS)
- [ ] **Delete** `temp.txt`
- [ ] **Delete** `sizes_output.txt`
- [ ] **Delete** `get_sizes.ps1`
- [ ] **Update** `CLAUDE.md` script load order to match `index.html`
- [ ] **Update** `CLAUDE.md` state variables table (remove `productmgmt` from `currentSection` list)
- [ ] **Update** `CLAUDE.md` repository structure diagram (remove `portals/productmgmt/` entry)
- [ ] **Review** 33 `console.log` statements for production readiness
